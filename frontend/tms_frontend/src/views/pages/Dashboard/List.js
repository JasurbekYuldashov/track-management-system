                    ...
                    >
                            <CardMui
                                ...
                                <CardContentMui>
                                    ...
                                    <TextField style={{width: '100%'}} value={this.state.note} onChange={this.handleChangeNote}  onKeyPress={this.handleKeyPress} label="Add note" variant="standard" />
                                    <div style={{height: (parseInt(document.getElementById('backdrop')?.clientHeight) - 140) + 'px', overflow: 'auto'}}>
                                        { this.state.notesData?.map((item, index)=>{
                                            return (
                                                <div style={{border: '1px solid silver', borderRadius: '10px', padding: '10px', marginBottom: '10px', marginTop: index===0 ? '10px': '0'}}>
