...
class EditUnit extends React.Component {
  ...
  componentDidMount() {
    fetch(`/driver/list?sort=id,DESC&size=10000`, {
      headers: {
        Authorization: this.props.token,
      },
    })
          ...
          .then((data) => {
            ...
            if (data.files !== null) {
              ...
              this.setState({
                ...
                secondDriver: secondDriver[0] && secondDriver[0],
                secondDriverId: secondDriver[0] && secondDriver[0].value,
                fileIds,
                prevFiles,
                status: data.unitStatusId,
                id: data.id,
                registrationExpirationTime: data.registrationExpirationTime,
  ...
  editUnit = () => {
    ...
    let data = {
      ...
      annualInspectionExpirationTime: this.state.annualInspectionExpirationTime,
                  ...
                  <div style={{ width: "50%", marginRight: 20 }}>
                    ...
                    <FormGroup className="align-items-center" row>
                      ...
                      <Col md="8">
                        ...
                        >
                          {this.state.unit_types.map((item) => (
                    ...
                    <FormGroup className="align-items-center" row>
                      ...
                      <Col md="8">
                        <CustomInput
                          ...
                          id="ownershipType"
                        >
                          {this.state.ownership_types.map((item) => (
                            <option key={item.id} value={item.id}>
                              {item.name}
                            </option>
                          ))}
                    ...
                    <FormGroup className="align-items-center" row>
                      ...
                      <Col md={this.state.status == 7 ? "4" : "8"}>
                        <CustomInput
                          type="select"
                          name="select"
                          id="status"
                        ...
                        >
                          {this.state.unitStatuses.map((item) => (
                            <option key={item.id} value={item.id}>
                              {item.name}
                            </option>
                          ))}
                    ...
                    <FormGroup className="align-items-center" row>
                      ...
                      <Col md="8">
                        <Flatpickr
                          ...
                          value={this.state.annualInspectionExpirationTime}
                          onChange={(e) => {
                            this.setState({
                              annualInspectionExpirationTime: Date.parse(e[0]),
                            });
                          }}
                        />
                      </Col>
                    ...
                    <FormGroup className="align-items-center" row>
                      ...
                      <Col md="8">
                        <Flatpickr
                          ...
                          value={this.state.registrationExpirationTime}
                          onChange={(e) => {
                            this.setState({
                              registrationExpirationTime: Date.parse(e[0]),
                            });
                          }}
                        />
                      </Col>
