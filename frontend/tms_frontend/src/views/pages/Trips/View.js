...
class View extends React.Component {
  ...
  componentDidMount() {
    fetch(`/trip/${this.props.match.params.id}`, {
      headers: {
  ...
  render() {
    ...
    return (
      <>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Trip number {this.props.match.params.id}</CardTitle>
          </CardHeader>
          <CardBody>
                      ...
                      <Col sm="9" md="6" lg="6">
                        <div className="users-page-view-table">
                          <div className="d-flex user-info">
                            ...
                            <div>{this.state.data.customerName}</div>
                          </div>
                          <div className="d-flex user-info">
                            <div className="user-info-title font-weight-bold">
                              Drivers
                            ...
                            <div className="text-truncate">
                              <span>
                                ...
                                >
                                  {this.state.data.driverName}
                                </Link>
                                {this.state.data.teammateName && (
                                  <>
                                    <br />
                                    <Link
                          ...
                          <div className="d-flex user-info">
                            ...
                            <div>{this.state.data.ownedCompanyName}</div>
                          </div>
                          <div className="d-flex user-info">
                            <div className="user-info-title font-weight-bold">
                              Driver <br /> Instructions
                            </div>
                            <div>{this.state.data.driverInstructions}</div>
                          </div>
                        </div>
                      </Col>
                      <Col md="12" lg="6">
                        <div className="users-page-view-table">
                          <div className="d-flex user-info">
                            ...
                            <div>{this.state.data.unitStatusName}</div>
                          </div>
                          <div className="d-flex user-info">
                            <div className="user-info-title font-weight-bold">
                              Driver Status
                            </div>
                            <div>{this.state.data.driverStatusName}</div>
                          </div>
                          <div className="d-flex user-info">
                            <div className="user-info-title font-weight-bold">
                              Accessory Pay
                            ...
                            <div>
                              <span>{this.state.data.accessoryDriverPay}</span>
                            </div>
                          </div>
                          <div className="d-flex user-info">
                            <div className="user-info-title font-weight-bold">
                            ...
                            <div>
                              <span>
                                {this.state.data.chronologicalSequence &&
                                  this.state.data.chronologicalSequence[0] &&
                                  this.state.data.chronologicalSequence[0]
