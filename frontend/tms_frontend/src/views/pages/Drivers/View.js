              ...
              <CardBody>
                <Row className="mx-0" col="12">
                  ...
                  <Col className="mt-1 pl-0 d-flex" sm="12">
                      {this.props.userRole !== "dispatcher" && <Link to={`/driver/edit/${this.props.match.params.id}`}>
                      <Button
                        className="mr-1"
                        color="primary"
                        type="button"
                      ...
                      {this.props.userRole !== "dispatcher" && <CustomInput
                      style={{ width: 230, height: 41 }}
                      type="select"
                      name="select"
                      id="driver_status"
              ...
              <CardBody>
                <div className="users-page-view-table">
                  ...
                  <div className="d-flex user-info">
                    ...
                    <div className="text-truncate">
                      <span>{data.medicalCardRenewalFormatted}</span>
                    </div>
                  </div>
                </div>
              </CardBody>
